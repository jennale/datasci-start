...
# 1096 entries without an age group, but have an age. Assign them age groups 
...
rm(age_groups, maxAge, collapsed_ages)
...
# We will assign the Probable Gender if % of either pronouns is > 60%. Anything else is labeled NA
